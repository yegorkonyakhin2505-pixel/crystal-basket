  ...
  return (
    <section className="container-x pt-12 md:pt-20 pb-20 max-w-3xl">
      ...
      <div className="text-cb-muted mt-6 space-y-4 text-[14px]">
        <p className="text-cb-ink text-[16px]">In plain words: our bracelets are jewellery. Crystal meanings describe what people have traditionally believed, not proven effects, so please see a doctor or therapist for anything health-related.</p>
