...
| **N05** | Real product & lifestyle photography | Replace AI placeholders | `apps/web/public/images/**`. Per-product on-wrist shots still wanted for Fortune, Alchemist, Devotion, Shield, Guardian, Aurora, Seven (they show a bead-detail crop, `images[1]`, until then; needs the Higgsfield connector back) | ⏳ AI placeholders live |
