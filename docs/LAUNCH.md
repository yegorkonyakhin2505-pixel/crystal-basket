...
| ✅ | **Nine real-stock single-stone bracelets** added as "Leaving soon" (2026-09-23): The Blush, Quiet, Clarity, Sunlit, Ember, Root, Vault, Prism, Night; fluorite as a 17th stone; product shots generated from Alya's photos; Shopify re-imported (22 products, 81 variants). Placeholder prices, see N21 | catalog + Shopify |
| ✅ | Stone library shows tumbled-stone photos instead of colour circles (2026-09-23) | `public/images/stones/` |
| ✅ | Site search (header icon + mobile drawer), stone photos in the stone menu, filters and chips, popovers close on outside click, fluorite stone photo, three product photos whitened, "Leaving soon" tag (2026-09-23) | `components/Store/SearchDialog.tsx`, `FilterBar.tsx`, `scripts/whiten-background.py` |
| ✅ | Builder upgraded (2026-09-23): photographic bead sprites, 2.5D ring, animations on every step; home section uses a generated teaser photo; stack photos cleaned (abundance cropped, protection regenerated from the three product shots) | `components/Store/BraceletBuilder.tsx`, `public/images/{beads,build,stacks}` |
